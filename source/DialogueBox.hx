...
class DialogueBox extends FlxSpriteGroup
{
	...
	public function new(talkingRight:Bool = true, ?dialogueList:Array<String>)
	{
		...
		else if (PlayState.SONG.song.toLowerCase() == 'glazomer')
		{
			portraitLeft = new FlxSprite(-1500, 10);
			portraitLeft.frames = Paths.getSparrowAtlas('portraits/zardyPortrait', 'shared');
			portraitLeft.animation.addByPrefix('enter', 'ZF Portrait Enter instance', 24, false);
	  ...
	  {
			portraitGf = new FlxSprite(-50, 40);
			portraitGf.frames = Paths.getSparrowAtlas('portraits/gfPortrait', 'shared');
			portraitGf.animation.addByPrefix('enter', 'BF Portrait Enter instance 1', 24, false);
