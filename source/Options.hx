...
class MegaBfOption extends Option
{
	public function new(desc:String)
	{
		super();
	...
	public override function press():Bool
	{
		FlxG.save.data.megaruvbf = !FlxG.save.data.megaruvbf;
		display = updateDisplay();
		return true;
	}
	...
	private override function updateDisplay():String
	{
		return FlxG.save.data.megaruvbf ? "MegaFreedoms Ruv Bf on" : "MegaFreedoms Ruv Bf off";
	}
}
