...
class PlayState extends MusicBeatState
{
	...
	override public function create()
	{
		...
		switch (songLowercase)
		{
			...
			case 'glazomer':
				dialogue = CoolUtil.coolTextFile(Paths.txt('glazomer/DIALOGUE'));
		}
			...
			case 'bedroom':
				{
						defaultCamZoom = 0.9;
						curStage = 'bedroom';
						var bg:FlxSprite = new FlxSprite(-600, -200).loadGraphic(Paths.image('bedroom'));
						bg.antialiasing = true;
						bg.scrollFactor.set(0.9, 0.9);
						bg.active = false;
						add(bg);
	...
	private function generateStaticArrows(player:Int):Void
	{
		for (i in 0...4)
		{
			...
			switch (SONG.noteStyle)
			{
				...
				case 'prism':
					babyArrow.frames = Paths.getSparrowAtlas('prism_notes');
